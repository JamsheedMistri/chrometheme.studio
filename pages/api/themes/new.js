...
module.exports = async (req, res) => {
	...
	const keys = [ 'frame', 'frame_inactive', 'frame_incognito', 'frame_incognito_inactive', 'background_tab', 'background_tab_inactive', 'background_tab_incognito', 'background_tab_incognito_inactive', 'tab_background_text', 'tab_background_text_inactive', 'tab_background_text_incognito', 'tab_background_text_incognito_inactive', 'toolbar', 'toolbar_button_icon', 'omnibox_text', 'omnibox_background', 'tab_text', 'bookmark_text' ];
