...
const Controls = React.memo(() => {
	...
	const renderCategory = (type) => {
		return orderedColorKeys
			...
			.map((color) => (
				<ColorControl key={color} id={color} color={colors[color]} data={colorData[color]} />
			))
	}
	...
	return (
		<div className={styles.container}>
			<p className={styles.instructions}>
				Click the colored box in each row to adjust the browser theme in real-time. Once you're
				done, click the "Download Theme" button above.
			</p>
