...
const DownloadModal = React.memo(() => {
	...
	return (
		<Modal open={modals.download} onClose={closeDownloadModal}>
			...
			<p>Follow these instructions in order to start using your new theme. If you are having trouble following the instructions, you can also view the tutorial video by <a href='https://www.youtube.com/watch?v=9MnJO3xX1jI' className={styles.link} target='_blank'>clicking here</a>.</p>
			<ol>
				<li>
					<p>Click the file at the bottom of your screen to un-zip it.</p>
				</li>
				<li>
					<p>Open a new tab and go to URL <span className={styles.link}>chrome://extensions</span> (or <span className={styles.link}>edge://extensions</span> if you're on Edge).</p>
				</li>
					<li>
						<p>At the top right, slide the switch that says <b>Developer mode</b> to turn on Developer Mode.</p>
						<p>Don't worry, this is only a theme, not an extension, so it can't do anything to your browser. (feel free to inspect the contents of the extension or the <a href='https://github.com/JamsheedMistri/chrometheme.studio' className={styles.link} target='_blank'>source code</a> of this website if you don't believe me)</p>
					</li>
				<li>
